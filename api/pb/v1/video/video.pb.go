...
func (x *VideoClass) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VideoClass) ProtoMessage() {}

func (x *VideoClass) ProtoReflect() protoreflect.Message {
	mi := &file_video_video_proto_msgTypes[0]
...
// Deprecated: Use VideoClass.ProtoReflect.Descriptor instead.
func (*VideoClass) Descriptor() ([]byte, []int) {
	return file_video_video_proto_rawDescGZIP(), []int{0}
}

func (x *VideoClass) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *VideoClass) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *VideoClass) GetDescription() string {
	if x != nil {
...
var file_video_video_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x08, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x2e, 0x76, 0x31, 0x22, 0x52, 0x0a,
	0x0a, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x43, 0x6c, 0x61, 0x73, 0x73, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x2f, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x3b, 0x70, 0x62, 0x5f, 0x76, 0x69, 0x64, 0x62, 0x06, 0x70,
...
var file_video_video_proto_goTypes = []interface{}{
	(*VideoClass)(nil), // 0: video.v1.VideoClass
}
